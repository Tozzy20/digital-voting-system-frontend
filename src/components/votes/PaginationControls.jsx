...
const PaginationControls = ({currentPage, totalPages, hasNext, hasPrev, onNextPage, onPrevPage}) => {
    return (
        <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
            <div className="flex items-center rounded-lg border border-[#CCCCCC] gap-2 px-3 py-2 sm:px-5 sm:py-4">
            ...
            <div className="flex items-center rounded-lg border border-[#CCCCCC] px-3 py-2 sm:px-5 sm:py-4">
                ...
                <button
                    onClick={onPrevPage}
                    disabled={!hasPrev}
                    className={`rounded-lg flex items-center justify-center ml-2 sm:ml-0 cursor-pointer ${!hasPrev ? 'opacity-50 cursor-not-allowed' : ''}`}
                >
                    <img 
                ...
                <button
                    onClick={onNextPage}
                    disabled={!hasNext}
                    className={`rounded-lg flex items-center justify-center ml-1 cursor-pointer ${!hasNext ? 'opacity-50 cursor-not-allowed' : ''}`}
                >
                    <img 
