...
const MainPage = () => {
    ...
    useEffect(() => {
        const fetchUser = async () => {
            ...
            const user = await userInfo(); // fetch с {credentials: 'include'}
        ...
        <>
            ...
            >
                ...
                <div className="grid grid-cols-6 gap-2 max-lg:grid-cols-3 max-md:grid-cols-2 max-sm:grid-cols-1">
                    <div
                        className="bg-white col-span-1 h-50 rounded-[20px] flex flex-col justify-center p-5 max-sm:col-span-1 max-md:col-span-2">
                    ...
                    <div
                        className="bg-white col-span-2 h-50 rounded-[20px] p-5 relative overflow-hidden max-sm:col-span-1">
                    ...
                    <div
                        className="bg-white col-span-2 h-50 rounded-[20px] p-5 relative overflow-hidden max-sm:col-span-1 max-md:col-span-2">
                        <div className="flex flex-col justify-center h-full">
                            <p className="text-[38px] font-bold max-md:text-[32px] max-sm:text-[28px]">
                                1.500
                            </p>
                    ...
                    <>
                        ...
                        <div className="flex gap-2 max-lg:flex-col">
                            <div className="flex flex-col gap-2 w-5/11 max-lg:w-full">
                                <div
                                    className="bg-white rounded-[20px] px-6 py-8 max-h-100 flex gap-2 max-lg:flex-col max-md:px-4 max-md:py-5">
                                ...
                                <div
                                    className="bg-white rounded-[20px] inline-flex flex-col justify-between p-5 h-[481px] max-md:h-auto max-md:p-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-2 max-md:grid-cols-1">
                                        <div
                                            className="col-span-1 rounded-2xl flex flex-col justify-between border-1 border-[#ccc] h-[150px] p-4 max-md:h-auto max-md:p-3">
                            ...
                            <div className="flex flex-col gap-2 w-6/11 max-lg:w-full">
                                <div
                                    className="bg-white rounded-[20px] inline-flex flex-col justify-between p-5 h-[431px] max-md:h-auto max-md:p-4">
                                    <p className="font-bold text-xl max-md:text-lg">
                                        Lorem Ipsum is simply dummy text of the printing and
                                        typesetting industry. Lorem Ipsum has been the
                                    </p>
                                    ...
                                    <div className="grid grid-cols-2 gap-2 max-md:grid-cols-1">
                                        ...
                                        <div
                                            className="col-span-1 rounded-2xl border-1 border-[#ccc] h-[150px] max-md:h-auto">
                                            <Chart2
                                                chartData={[0, 5, 6, 8, 7, 10]}
                                        ...
                                        <RedButton
                                            ...
                                            className="max-md:py-2 max-md:text-sm"
                                        />
                                    </div>
                                </div>
                                <div
                                    className="bg-white rounded-[20px] inline-flex flex-col justify-between p-5 h-[450px] max-md:h-auto max-md:p-4">
                                    <p className="font-bold text-xl max-md:text-lg">
                                        Lorem Ipsum is simply dummy text of the printing and
                                        typesetting industry. Lorem Ipsum has been the
                                    </p>
                ...
                {roleId !== 3 && (
                    <div className="grid grid-cols-9 gap-2 mt-2 max-lg:grid-cols-1 max-lg:gap-4">
                        <div
                            className="bg-white rounded-[20px] col-span-5 h-[782px] flex flex-col justify-between p-6 max-lg:col-span-1 max-md:h-auto max-md:p-4">
                        ...
                        <div
                            className="bg-white rounded-[20px] col-span-4 h-[782px] p-6 max-lg:col-span-1 max-md:h-auto max-md:p-4">
                ...
                >
                    ...
                    {roleId !== 3 && (
                        <div
                            className="bg-white rounded-[20px] max-h-[640px] col-span-4 row-span-2 sm:top-[-40px] p-5 max-lg:col-span-3 max-md:col-span-2 max-sm:col-span-3 max-md:p-4">
                            <p className="font-bold text-xl max-md:text-lg">
                    ...
                    {roleId === 3 && (
                        <div
                            className="bg-white rounded-[20px] flex flex-col justify-between h-86 p-5 max-md:p-4 max-lg:col-span-3">
                            <p className="font-bold text-xl max-md:text-lg">
                                Регистрация и голосование
                            </p>
                            <p className="font-normal text-base text-[#CCCCCC] max-md:text-sm">
