  ...
  return (
    ...
    >
      ...
      <div className="relative w-full overflow-hidden mask-image">
        ...
        <div className="absolute text-white top-[940px] left-80 text-5xl tracking-[0] leading-[normal]">
          КРИПТОГОЛОСОВАНИЕ
        </div>

        <div className="absolute text-white top-[990px] left-80 text-5xl tracking-[0] leading-[normal]">
          НА БЛОКЧЕЙНЕ
        </div>

        <div className="absolute text-white font-mak top-[62px] left-80 text-[40px] whitespace-nowrap tracking-[0] leading-[normal]">
          Главная
        </div>

        <div className="absolute top-[33px] left-80 text-base whitespace-nowrap tracking-[0] leading-[normal]">
          Главная
        </div>
      </div>
      ...
      <div className="flex gap-4 px-[8%] mt-8 w-full max-w-[80%] mx-auto mb-[2%]">
      ...
      <div className="flex flex-col w-full max-w-[473px] gap-2.5">
        <Card className="w-full rounded-[20px] overflow-hidden shadow-[0px_2px_10px_#00000040]">
          <CardContent className="p-0 relative">
            <div className="flex flex-col w-[327px] items-start gap-2.5 p-6">
              <div className="relative  text-center tracking-[0] leading-[normal]">
                Количество голосующих
              </div>
                  <div className="relative self-stretch text-lowgrey text-base tracking-[0] leading-[normal]">
                Динамика голосующих по дням
              </div>
            </div>

            <div className="flex w-[425px] h-24 items-end gap-[5px] mx-6 mt-12">
            ...
            <div className="flex w-[425px] items-center justify-between mx-6 mt-[82px] m-6">
              {chartDates.map((date, index) => (
                <div
                  key={`date-${index}`}
                  className="relative w-fit mt-[-1.00px] text-base whitespace-nowrap tracking-[0] leading-[normal]"
                >
                  {date}
                </div>
              ))}
        ...
        <Card className="w-full rounded-[20px] overflow-hidden shadow-[0px_2px_10px_#00000040]">
          <CardContent className="p-0 relative">
            <div className="flex flex-col w-[327px] items-start gap-2.5 p-6">
              <div className="relative self-stretch mt-[-1.00px] text-center tracking-[0] leading-[normal]">
                Количество голосующих
              </div>
              <div className="relative self-stretch text-base text-center tracking-[0] leading-[normal]">
               Всего проголосовало
              </div>
            </div>

            <div className="inline-flex items-start justify-end gap-2.5 mx-6">
              <div className="relative w-fit mt-[-1.00px] text-cryptblack text-8xl tracking-[0] leading-[normal] whitespace-nowrap">
                1500
              </div>
              <Badge className="bg-green-200 p-1 h-auto">
                <span className="text-base">+16%</span>
              </Badge>
            </div>

            <div className="m-6 mx-6 text-base whitespace-nowrap tracking-[0] leading-[normal]">
